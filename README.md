...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v13.0.1--beta-blueviolet?style=flat-square" />
...
<p align="center">
  ...
  <a href="https://groupfinder.eu/library/dungeon-master-tool"><img src="media/gf-bar-rw.png" alt="Support us on GroupFinder Library" height="40" /></a>
</p>
...
- **Android** — Install `DungeonMasterTool-Android.apk` from the [latest release](https://github.com/elymsyr/dungeon-master-tool/releases/latest); allow unknown sources if prompted.
- **Windows** — Extract `DungeonMasterTool-Windows.zip` and run `dungeon_master_tool.exe`.
- **Linux** — Extract `DungeonMasterTool-Linux.zip`, then `cd bundle && ./dungeon_master_tool`.
...
Licensed under [CC BY-NC 4.0](LICENSE). Bugs: [GitHub Issues](https://github.com/elymsyr/dungeon-master-tool/issues) · Instagram [@erenorhun](https://www.instagram.com/erenorhun) · LinkedIn [Orhun Eren Yalcinkaya](https://www.linkedin.com/in/orhuneren) · Email orhun868@gmail.com