...
class CombatControlsWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.btn_new_enc.setObjectName("compactBtn")
        self.btn_new_enc.setFixedSize(28, 28)
        ...
        self.btn_rename_enc.setFixedSize(44, 28)
        ...
        self.btn_del_enc.setFixedSize(28, 28)
        ...
        self.btn_quick_add.setObjectName("successBtn")
        ...
        self.btn_add_players.setObjectName("primaryBtn")
