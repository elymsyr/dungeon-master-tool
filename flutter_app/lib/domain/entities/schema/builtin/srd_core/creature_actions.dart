...
List<Map<String, dynamic>> srdCreatureActions() => [
      ...
      // Generic breath weapon templates (Acid/Lightning/Cold/Poison Breath) live earlier in this file
      // with dragon-tuned numbers; younger dragons share that name and accept its DC/dice baseline.
      ...
      _a(name: 'Corrupting Touch (Banshee)', actionType: 'Action', isAttack: true, attackKind: 'Melee Spell', attackBonus: 4, reachFt: 5, damageDice: '3d6+2', damageType: 'Necrotic', description: '*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 12 (3d6 + 2) Necrotic damage.'),
      _a(name: 'Horrifying Visage (Banshee)', actionType: 'Action', saveDc: 13, saveAbility: 'Wisdom', description: 'Each non-Undead creature within 60 feet that can see the banshee makes a DC 13 Wisdom save. *Failure:* Frightened for 1 minute and ages 1d4 × 10 years if Humanoid (reversed by Greater Restoration). The target repeats the save at end of each turn, ending the effect on a success. *Success:* Immune for 24 hours.', conditions: ['Frightened']),
