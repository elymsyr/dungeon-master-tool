...
List<Map<String, dynamic>> srdCreatureActions() => [
      ...
      _a(name: 'Bite (Giant Spider)', actionType: 'Action', isAttack: true, attackKind: 'Melee Weapon', attackBonus: 5, reachFt: 5, damageDice: '1d8+3', damageType: 'Piercing', description: '*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 7 (1d8 + 3) Piercing damage plus 9 (2d8) Poison damage. The target must make a DC 11 Constitution save: on a fail, it has the Poisoned condition for 1 hour; if the save fails by 5+, the target also has the Unconscious condition while Poisoned.'),
      _a(name: 'Web (Giant Spider)', actionType: 'Action', isAttack: true, attackKind: 'Ranged Weapon', attackBonus: 5, rangeNormalFt: 30, rangeLongFt: 60, damageType: 'Force', description: '*Ranged Attack Roll:* +5, range 30/60 ft. *Hit:* The target has the Restrained condition (escape DC 12). The webbing is destroyed if it takes 5 Slashing or Fire damage.'),
