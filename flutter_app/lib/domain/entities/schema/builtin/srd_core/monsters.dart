...
List<Map<String, dynamic>> srdMonsters() => [
      ...
      packEntity(slug: 'monster', name: 'Ancient Brass Dragon', description: 'An ancient brass dragon, sage of the desert wastes.', attributes: {'size_ref': lookup('size', 'Gargantuan'), 'creature_type_ref': lookup('creature-type', 'Dragon'), 'alignment_ref': lookup('alignment', 'Chaotic Good'), 'ac': 20, 'initiative_modifier': 14, 'initiative_score': 24, 'hp_average': 297, 'hp_dice': '17d20+119', 'speed_walk_ft': 40, 'speed_burrow_ft': 30, 'speed_fly_ft': 80, 'stat_block': {'STR': 27, 'DEX': 10, 'CON': 25, 'INT': 16, 'WIS': 15, 'CHA': 19}, 'cr': '20', 'xp': 25000, 'proficiency_bonus': 6, 'passive_perception': 25, 'senses': [{'sense': 'Blindsight', 'range_ft': 60}, {'sense': 'Darkvision', 'range_ft': 120}], 'language_refs': [lookup('language', 'Common'), lookup('language', 'Draconic')], 'damage_immunity_refs': [lookup('damage-type', 'Fire')], 'trait_refs': [ref('trait', 'Legendary Resistance (3/Day, or 4/Day in Lair)')], 'action_refs': [ref('creature-action', 'Multiattack'), ref('creature-action', 'Rend (Dragon)'), ref('creature-action', 'Fire Breath'), ref('creature-action', 'Sleep Breath')], 'legendary_action_uses': 3}),
