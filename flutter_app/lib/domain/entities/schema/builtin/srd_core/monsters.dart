...
List<Map<String, dynamic>> srdMonsters() => [
      ...
      packEntity(slug: 'monster', name: 'Knight', description: 'A trained warrior of noble bearing, sworn to a code.', attributes: {'size_ref': 'Medium', 'creature_type_ref': lookup('creature-type', 'Humanoid'), 'alignment_ref': 'Lawful Neutral', 'ac': 18, 'initiative_modifier': 0, 'initiative_score': 10, 'hp_average': 52, 'hp_dice': '8d8+16', 'speed_walk_ft': 30, 'stat_block': {'STR': 16, 'DEX': 11, 'CON': 14, 'INT': 11, 'WIS': 11, 'CHA': 15}, 'cr': '3', 'xp': 700, 'proficiency_bonus': 2, 'passive_perception': 10, 'language_refs': [lookup('language', 'Common')], 'trait_refs': [ref('trait', 'Brave')], 'action_refs': [ref('creature-action', 'Multiattack'), ref('creature-action', 'Longsword (Knight)'), ref('creature-action', 'Heavy Crossbow (Knight)')]}),
      ...
      packEntity(slug: 'monster', name: 'Veteran', description: 'A career soldier hardened by countless campaigns.', attributes: {'size_ref': 'Medium', 'creature_type_ref': lookup('creature-type', 'Humanoid'), 'alignment_ref': 'Neutral', 'ac': 17, 'initiative_modifier': 1, 'initiative_score': 11, 'hp_average': 58, 'hp_dice': '9d8+18', 'speed_walk_ft': 30, 'stat_block': {'STR': 16, 'DEX': 13, 'CON': 14, 'INT': 10, 'WIS': 11, 'CHA': 10}, 'cr': '3', 'xp': 700, 'proficiency_bonus': 2, 'passive_perception': 12, 'language_refs': [lookup('language', 'Common')], 'action_refs': [ref('creature-action', 'Multiattack'), ref('creature-action', 'Longsword (Veteran)'), ref('creature-action', 'Shortsword (Veteran)'), ref('creature-action', 'Heavy Crossbow (Veteran)')]}),
      ...
      packEntity(slug: 'monster', name: 'Pit Fiend', description: 'A general of Hell, supreme commander of devil armies.', attributes: {'size_ref': 'Large', 'creature_type_ref': lookup('creature-type', 'Fiend'), 'tags_line': '(devil)', 'alignment_ref': 'Lawful Evil', 'ac': 21, 'initiative_modifier': 14, 'initiative_score': 24, 'hp_average': 337, 'hp_dice': '25d10+200', 'speed_walk_ft': 30, 'speed_fly_ft': 60, 'stat_block': {'STR': 26, 'DEX': 14, 'CON': 26, 'INT': 22, 'WIS': 18, 'CHA': 24}, 'cr': '20', 'xp': 25000, 'proficiency_bonus': 6, 'passive_perception': 14, 'senses': [{'sense': 'Truesight', 'range_ft': 120}], 'damage_immunity_refs': [lookup('damage-type', 'Fire'), lookup('damage-type', 'Poison')], 'condition_immunity_refs': [lookup('condition', 'Poisoned')], 'language_refs': [lookup('language', 'Common'), lookup('language', 'Infernal')], 'telepathy_ft': 120, 'trait_refs': [ref('trait', 'Magic Resistance'), ref('trait', 'Magic Weapons'), ref('trait', 'Fear Aura')], 'action_refs': [ref('creature-action', 'Multiattack'), ref('creature-action', 'Mace (Pit Fiend)'), ref('creature-action', 'Bite (Pit Fiend)'), ref('creature-action', 'Fireball (Pit Fiend)')]}),
