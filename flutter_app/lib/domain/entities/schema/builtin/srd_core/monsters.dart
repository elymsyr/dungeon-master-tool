...
List<Map<String, dynamic>> srdMonsters() => [
      ...
      packEntity(slug: 'monster', name: 'Storm Giant', description: 'A noble giant of stormclouds and thunder.', attributes: {'size_ref': lookup('size', 'Huge'), 'creature_type_ref': lookup('creature-type', 'Giant'), 'alignment_ref': lookup('alignment', 'Chaotic Good'), 'ac': 16, 'initiative_modifier': 8, 'initiative_score': 18, 'hp_average': 230, 'hp_dice': '20d12+100', 'speed_walk_ft': 50, 'speed_swim_ft': 50, 'stat_block': {'STR': 29, 'DEX': 14, 'CON': 20, 'INT': 16, 'WIS': 18, 'CHA': 18}, 'cr': '13', 'xp': 10000, 'proficiency_bonus': 5, 'passive_perception': 19, 'damage_immunity_refs': [lookup('damage-type', 'Lightning'), lookup('damage-type', 'Thunder')], 'resistance_refs': [lookup('damage-type', 'Cold')], 'language_refs': [lookup('language', 'Common'), lookup('language', 'Giant')], 'action_refs': [ref('creature-action', 'Multiattack'), ref('creature-action', 'Thunderous Greatsword (Storm Giant)'), ref('creature-action', 'Lightning Strike (Storm Giant)')]}),
