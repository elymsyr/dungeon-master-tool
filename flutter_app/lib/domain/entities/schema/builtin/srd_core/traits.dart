...
List<Map<String, dynamic>> srdTraits() => [
      ...
      _t(name: 'Evasion (Monster)', kind: 'Defensive', description: 'If the creature is subjected to an effect that allows it to make a Dex save to take only half damage, the creature instead takes no damage if it succeeds and only half damage if it fails.'),
      ...
      _t(name: 'Brave (Monster)', kind: 'Defensive', description: 'The creature has Advantage on saving throws against being Frightened.'),
      ...
      // ── Class passive traits ─────────────────────────────────────────────
      _t(name: 'Dwarven Toughness', kind: 'Defensive',
          description: 'Your HP maximum increases by 1, and it increases by 1 again whenever you gain a level.'),
      _t(name: 'Fast Movement', kind: 'Movement',
          description: 'Your Speed increases by 10 feet while you aren\'t wearing Heavy armor.'),
      _t(name: 'Feral Instinct', kind: 'Defensive',
          description: 'You have Advantage on Initiative rolls.'),
      _t(name: 'Frenzy', kind: 'Passive',
          description: 'When you Reckless Attack while Raging, you deal extra damage to the first target you hit on your turn with a Strength-based attack. Roll a number of d6s equal to your Rage Damage bonus; the extra damage matches the weapon\'s type.'),
      _t(name: 'Mindless Rage', kind: 'Defensive',
          description: 'Immune to Charmed and Frightened conditions while Raging. If you\'re Charmed or Frightened when entering Rage, the condition ends.'),
      _t(name: 'Aura of Protection', kind: 'Defensive',
          description: 'You and friendly creatures within 10 feet of you gain a bonus to saving throws equal to your Charisma modifier (min +1). Aura is inactive while you have the Incapacitated condition.'),
      _t(name: 'Aura of Courage', kind: 'Defensive',
          description: 'You and your allies have Immunity to the Frightened condition while in your Aura of Protection.'),
      _t(name: 'Faithful Steed', kind: 'Spellcasting',
          description: 'You always have the Find Steed spell prepared. You can also cast it once without expending a spell slot, regaining the ability to do so when you finish a Long Rest.'),
      _t(name: 'Paladin\'s Smite', kind: 'Spellcasting',
      ...
      _t(name: 'Radiant Strikes', kind: 'Passive',
          description: 'Once per turn, when you hit a target with an attack roll using a Melee weapon or an Unarmed Strike, the target takes an extra 1d8 Radiant damage.'),
      _t(name: 'Tactical Mind', kind: 'Passive',
          description: 'When you fail an ability check, expend a use of Second Wind (no HP regain) to roll 1d10 and add it to the check. If it would still fail, no Second Wind use is consumed.'),
      _t(name: 'Tactical Shift', kind: 'Movement',
          description: 'When you activate Second Wind, you can move up to half your Speed without provoking Opportunity Attacks.'),
      _t(name: 'Indomitable', kind: 'Defensive',
          description: 'If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. Uses scale: 1 per Long Rest at L9, 2 at L13, 3 at L17.'),
      _t(name: 'Improved Critical', kind: 'Passive',
          description: 'Your weapon attacks and Unarmed Strikes can score a Critical Hit on a roll of 19 or 20.'),
      _t(name: 'Remarkable Athlete', kind: 'Passive',
          description: 'You have Advantage on Initiative rolls and Strength (Athletics) checks. After scoring a Critical Hit, you can move up to half your Speed without provoking Opportunity Attacks.'),
      _t(name: 'Heroic Warrior', kind: 'Passive',
          description: 'During combat, you can give yourself Heroic Inspiration whenever you start your turn without it.'),
      _t(name: 'Deft Explorer', kind: 'Other',
          description: 'Gain Expertise in one of your skill proficiencies; learn an extra language. More benefits at higher Ranger levels.'),
      _t(name: 'Roving', kind: 'Movement',
          description: 'Your Speed increases by 5 feet, and you gain a Climb Speed and a Swim Speed equal to your Speed.'),
      _t(name: 'Hunter\'s Prey', kind: 'Passive',
          description: 'You gain one Hunter feature option: Colossus Slayer (1d8 extra damage to wounded creatures) or Horde Breaker (extra attack vs a second target within 5 ft of the first).'),
      _t(name: 'Defensive Tactics', kind: 'Defensive',
          description: 'You gain one Hunter option: Escape the Horde (Opportunity Attacks against you have Disadvantage) or Multiattack Defense (attackers have Disadvantage on attack rolls against you after they hit).'),
      _t(name: 'Tireless', kind: 'Defensive',
          description: 'As a Magic action, grant yourself Temporary HP = 1d8 + Wis modifier. Uses = Wis mod per Long Rest. Also reduce one level of Exhaustion on a Short Rest.'),
      _t(name: 'Cunning Strike', kind: 'Passive',
          description: 'When you deal Sneak Attack damage, you can add a Cunning Strike effect (Poison, Trip, Withdraw, etc.) by forgoing Sneak Attack damage dice equal to the effect\'s cost.'),
      _t(name: 'Reliable Talent', kind: 'Passive',
          description: 'Whenever you make an ability check that uses one of your skill or tool proficiencies, treat a d20 roll of 9 or lower as a 10.'),
      _t(name: 'Slippery Mind', kind: 'Defensive',
          description: 'You gain proficiency in Wisdom and Charisma saving throws.'),
      _t(name: 'Open Hand Technique', kind: 'Passive',
          description: 'When you hit a creature with an attack granted by Flurry of Blows, you can impose Addle (no Opportunity Attacks until start of its next turn), Push (Str save vs 15 ft push), or Topple (Dex save vs Prone).'),
      _t(name: 'Disciple of Life', kind: 'Spellcasting',
          description: 'When you cast a level 1+ spell that restores HP, the target regains additional HP = 2 + the spell\'s level.'),
      _t(name: 'Blessed Healer', kind: 'Spellcasting',
          description: 'When you cast a level 1+ healing spell on others, you regain HP = 2 + the spell\'s level.'),
      _t(name: 'Draconic Resilience', kind: 'Defensive',
          description: 'Your HP maximum increases by 3 and again by 1 at each Sorcerer level. While not wearing armor, your AC equals 10 + Dex mod + Cha mod.'),
      _t(name: 'Elemental Affinity', kind: 'Passive',
          description: 'Choose a damage type associated with dragons (Acid, Cold, Fire, Lightning, or Poison). You have Resistance to that damage type; when you cast a spell that deals damage of that type, add your Cha modifier to one damage roll.'),
      _t(name: 'Dragon Companion', kind: 'Spellcasting',
          description: 'You always have Summon Dragon prepared. You can also cast it once without expending a spell slot; the cast doesn\'t require Concentration if you spend 3 Sorcery Points on it.'),
      _t(name: 'Dark One\'s Blessing', kind: 'Defensive',
          description: 'When you reduce an enemy to 0 HP, you gain Temporary HP = Cha modifier + Warlock level (min 1). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 HP.'),
      _t(name: 'Dark One\'s Own Luck', kind: 'Defensive',
          description: 'When you make an ability check or save, you can use this feature to add 1d10 to the roll (after rolling, before effects). Uses = Cha mod per Short or Long Rest.'),
      _t(name: 'Fiendish Resilience', kind: 'Defensive',
          description: 'Choose one damage type (not Force) on a Short or Long Rest. You have Resistance to that damage type until you choose a different one with this feature.'),
      _t(name: 'Sculpt Spells', kind: 'Passive',
          description: 'When you cast an Evocation spell that affects others you can see, choose a number of them equal to 1 + the spell\'s level; the chosen creatures automatically succeed on their save against the spell and take no damage if it would normally deal half on success.'),
      _t(name: 'Magical Cunning', kind: 'Spellcasting',
          description: 'On a Short Rest, regain expended Pact Magic spell slots equal to half your max (rounded up). Once per Long Rest.'),
      _t(name: 'Pact Boon', kind: 'Spellcasting',
          description: 'You gain a Pact Boon — Pact of the Blade (conjure pact weapon, Cha for attacks), Pact of the Chain (Find Familiar with special forms), or Pact of the Tome (Book of Shadows with extra cantrips + ritual spells).'),
      _t(name: 'Ritual Adept', kind: 'Spellcasting',
          description: 'You can cast any spell with the Ritual tag from your spellbook without expending a spell slot, even if not prepared.'),
      _t(name: 'Scholar (Wizard)', kind: 'Passive',
          description: 'Choose one of these skills: Arcana, History, Investigation, Medicine, Nature, or Religion. You have Expertise in that skill.'),
      _t(name: 'Uncanny Metabolism', kind: 'Defensive',
          description: 'When you roll Initiative, you can regain all expended Focus Points. When you do so, roll your Martial Arts die and regain HP = Monk level + the roll. Once per Long Rest.'),
      _t(name: 'Land\'s Stride', kind: 'Movement',
          description: 'You ignore Difficult Terrain made of nonmagical plants. Magical Difficult Terrain caused by plants requires no save to pass through.'),
      _t(name: 'Nature\'s Ward', kind: 'Defensive',
          description: 'You are immune to the Poisoned condition, and you have Resistance to a damage type associated with your current land choice (Fire/Cold/Lightning/Poison).'),
      _t(name: 'Empowered Strikes', kind: 'Passive',
          description: 'Your Unarmed Strikes count as magical for resistance bypass. You can choose to have them deal Force damage instead of their normal type.'),
      _t(name: 'Evasion', kind: 'Defensive',
          description: 'When you make a Dex save against an effect that allows half damage on success, you take no damage on a success and half damage on a failure (unless Incapacitated).'),
      _t(name: 'Acrobatic Movement', kind: 'Movement',
          description: 'While you aren\'t wearing armor or wielding a Shield, you can move along vertical surfaces and across liquids on your turn without falling during the movement.'),
      _t(name: 'Perfect Focus', kind: 'Defensive',
          description: 'When you roll Initiative and don\'t use Uncanny Metabolism, you regain Focus Points until you have 4 if you have 3 or fewer.'),
      _t(name: 'Stunning Strike', kind: 'Passive',
          description: 'Once per turn when you hit with a Monk weapon or Unarmed Strike, spend 1 Focus Point to force the target to make a Con save or be Stunned until the start of your next turn.'),
      _t(name: 'Heightened Focus', kind: 'Passive',
          description: 'Your Flurry of Blows, Patient Defense, and Step of the Wind gain enhanced benefits (extra Unarmed Strike, Temp HP, or auto-Disengage).'),
    ];
