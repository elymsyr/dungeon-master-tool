...
List<Map<String, dynamic>> srdAnimals() => [
      ...
      packEntity(
        ...
        attributes: {
          ...
          'skill_bonuses': skills(const {'Stealth': 'p'}),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'senses': [{'sense_ref': lookup('sense', 'Darkvision'), 'range_ft': 30}],
          'trait_refs': [ref('trait', 'Keen Smell')],
      ...
      packEntity(
        ...
        attributes: {
          ...
          'skill_bonuses': skills(const {'Perception': 'p', 'Stealth': 'p'}),
          'senses': [{'sense_ref': lookup('sense', 'Blindsight'), 'range_ft': 10}],
      ...
      packEntity(
        ...
        attributes: {
          ...
          'skill_bonuses': skills(
            const {'Perception': 'p', 'Stealth': 'p'},
            misc: const {'Stealth': 1},
          ),
          'senses': [{'sense_ref': lookup('sense', 'Darkvision'), 'range_ft': 30}],
          'trait_refs': [ref('trait', 'Amphibious'), ref('trait', 'Standing Leap')],
      ...
      packEntity(
        ...
        attributes: {
          ...
          'senses': [{'sense_ref': lookup('sense', 'Blindsight'), 'range_ft': 30}],
      ...
      packEntity(
        ...
        attributes: {
          ...
          'save_bonuses': saves(const ['STR', 'WIS']),
          'skill_bonuses': skills(const {'Perception': 'p'}),
          'action_refs': [
            ref('creature-action', 'Multiattack'),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'save_bonuses': saves(const ['STR', 'CON']),
          'trait_refs': [ref('trait', 'Trampling Charge')],
          'action_refs': [
      ...
      packEntity(
        ...
        attributes: {
          ...
          'skill_bonuses': skills(const {'Perception': 'p', 'Stealth': 'p'}),
          'senses': [{'sense_ref': lookup('sense', 'Blindsight'), 'range_ft': 120}],
          'trait_refs': [
      ...
      packEntity(
        ...
        attributes: {
          ...
          'skill_bonuses': skills(const {'Perception': 'p'}),
          'senses': [{'sense_ref': lookup('sense', 'Blindsight'), 'range_ft': 60}],
          'trait_refs': [
