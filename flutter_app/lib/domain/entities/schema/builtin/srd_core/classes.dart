...
/// Like `_f` but with explicit grant lists folded onto the PC at creation /
/// level-up time via wizard `absorbFeatureRows` and editor
/// `absorbFeatureRowsInRange`. Use for feature rows that hand the PC an
/// Action / Bonus Action / Reaction / Trait / Feat lookup ref.
...
List<Map<String, dynamic>> srdClasses() => [
      ...
      packEntity(
        ...
        attributes: {
          ...
          'weapon_mastery_filter': 'melee_simple_or_martial',
          'armor_training_refs': [
          ...
          'features': [
            _fg(1, 'Rage',
                ...
                bonusActions: [ref('creature-action', 'Rage')]),
            _fg(1, 'Unarmored Defense',
                'While not wearing armor, your AC = 10 + Dex mod + Con mod. You can use a Shield and still gain this benefit.',
                traits: [ref('trait', 'Unarmored Defense (Barbarian)')]),
            _fg(1, 'Weapon Mastery',
                ...
                traits: [ref('trait', 'Weapon Mastery')]),
            _fg(2, 'Danger Sense',
                'Advantage on Dex saves while not Incapacitated.',
                traits: [ref('trait', 'Danger Sense')]),
            _fg(2, 'Reckless Attack',
                ...
                traits: [ref('trait', 'Reckless Attack')]),
            ...
            _fg(5, 'Fast Movement',
                ...
                traits: [ref('trait', 'Fast Movement')]),
            _fg(7, 'Feral Instinct', 'Advantage on Initiative rolls.',
                traits: [ref('trait', 'Feral Instinct')]),
        ...
        attributes: {
          ...
          'features': [
            _fg(1, 'Bardic Inspiration',
                ...
                bonusActions: [ref('creature-action', 'Bardic Inspiration')]),
            _fg(1, 'Spellcasting',
                'You know cantrips and spells from the Bard list. Charisma is your spellcasting ability.',
                traits: [ref('trait', 'Spellcasting Focus')]),
            _fg(2, 'Expertise',
                ...
                traits: [ref('trait', 'Expertise')]),
            _fg(2, 'Jack of All Trades',
                'Add half your PB (rounded down) to ability checks that don\'t already include it.',
                traits: [ref('trait', 'Jack of All Trades')]),
            _f(3, 'Bard Subclass',
      ...
      packEntity(
        ...
        attributes: {
          ...
          'l1_order_feat_category': 'Divine Order',
          'armor_training_refs': [
            lookup('armor-category', 'Light'),
            lookup('armor-category', 'Medium'),
            lookup('armor-category', 'Shield'),
          ...
          'starting_gold_dice': '5d4 × 10',
          'features': [
            _fg(1, 'Spellcasting', 'You know Cleric cantrips and prepare spells from the Cleric list. Wisdom is your spellcasting ability. Your Holy Symbol is your spellcasting focus.',
                traits: [ref('trait', 'Spellcasting Focus')]),
            _fg(1, 'Divine Order',
                ...
                traits: [ref('trait', 'Divine Order')]),
            _fg(2, 'Channel Divinity',
                'You gain Divine Spark and Turn Undead. Use Channel Divinity twice per Short Rest.',
                actions: [
                  ref('creature-action', 'Channel Divinity'),
                  ref('creature-action', 'Turn Undead'),
                ]),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'weapon_proficiency_categories': [lookup('weapon-category', 'Simple')],
          'granted_tool_refs': [ref('tool', 'Herbalism Kit')],
          'l1_order_feat_category': 'Primal Order',
          'granted_languages': [lookup('language', 'Druidic')],
          'armor_training_refs': [
            lookup('armor-category', 'Light'),
            lookup('armor-category', 'Medium'),
            lookup('armor-category', 'Shield'),
          ...
          'starting_gold_dice': '2d4 × 10',
          'features': [
            _fg(1, 'Spellcasting', 'You know Druid cantrips and prepare spells from the Druid list. Wisdom is your spellcasting ability. Your Druidic Focus is your spellcasting focus.',
                traits: [ref('trait', 'Spellcasting Focus')]),
            _fg(1, 'Druidic',
                'You know the secret druidic language. Bonus Action to leave a magical message understandable only to other druids.',
                traits: [ref('trait', 'Druidic')]),
            _f(1, 'Primal Order',
            ...
            _fg(2, 'Wild Shape',
                ...
                actions: [ref('creature-action', 'Wild Shape')]),
            _f(2, 'Wild Companion',
      ...
      packEntity(
        ...
        attributes: {
          ...
          'weapon_mastery_filter': 'simple_or_martial',
          'armor_training_refs': [
            lookup('armor-category', 'Light'),
            lookup('armor-category', 'Medium'),
          ...
          'features': [
            ...
            _fg(1, 'Second Wind',
                ...
                bonusActions: [ref('creature-action', 'Second Wind')]),
            _fg(1, 'Weapon Mastery',
            ...
            _fg(2, 'Action Surge',
                ...
                actions: [ref('creature-action', 'Action Surge')]),
            _fg(2, 'Tactical Mind',
                ...
                traits: [ref('trait', 'Tactical Mind')]),
            ...
            _fg(9, 'Tactical Shift',
                'When you Second Wind, also move up to half your Speed without provoking Opportunity Attacks.',
                traits: [ref('trait', 'Tactical Shift')]),
            _fg(9, 'Indomitable',
                'If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. Once per Long Rest at L9; scales to two uses at L13 and three at L17.',
                traits: [ref('trait', 'Indomitable')]),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'tool_proficiency_options': [
            ref('tool', "Alchemist's Supplies"),
            ref('tool', "Brewer's Supplies"),
            ref('tool', "Calligrapher's Supplies"),
            ref('tool', "Carpenter's Tools"),
            ref('tool', "Cartographer's Tools"),
            ref('tool', "Cobbler's Tools"),
            ref('tool', "Cook's Utensils"),
            ref('tool', "Glassblower's Tools"),
            ref('tool', "Jeweler's Tools"),
            ref('tool', "Leatherworker's Tools"),
            ref('tool', "Mason's Tools"),
            ref('tool', "Painter's Supplies"),
            ref('tool', "Potter's Tools"),
            ref('tool', "Smith's Tools"),
            ref('tool', "Tinker's Tools"),
            ref('tool', "Weaver's Tools"),
            ref('tool', "Woodcarver's Tools"),
            ref('tool', 'Bagpipes'),
            ref('tool', 'Drum'),
            ref('tool', 'Dulcimer'),
            ref('tool', 'Flute'),
          ...
          'features': [
            _fg(1, 'Martial Arts',
                ...
                traits: [ref('trait', 'Martial Arts')]),
            _fg(1, 'Unarmored Defense',
                'While not in armor and not wielding a Shield, AC = 10 + Dex mod + Wis mod.',
                traits: [ref('trait', 'Unarmored Defense (Monk)')]),
            _fg(2, 'Monk\'s Focus',
                ...
                bonusActions: [
                  ref('creature-action', 'Flurry of Blows'),
                  ref('creature-action', 'Patient Defense'),
                  ref('creature-action', 'Step of the Wind'),
                ]),
            _f(2, 'Unarmored Movement', '+10 ft. Speed while unarmored, scaling with level.'),
            _fg(2, 'Uncanny Metabolism',
                'When you roll Initiative, you can regain all expended Focus Points. When you do so, roll your Martial Arts die and regain HP = Monk level + the roll. Once per Long Rest.',
                traits: [ref('trait', 'Uncanny Metabolism')]),
            _f(3, 'Monk Subclass', 'Choose a subclass (Warrior of the Open Hand in this SRD).'),
            _fg(3, 'Deflect Attacks',
                ...
                reactions: [ref('creature-action', 'Deflect Attacks')]),
            _fg(4, 'Slow Fall', 'Reaction to reduce falling damage by 5 × Monk level.',
                reactions: [ref('creature-action', 'Slow Fall')]),
            _f(5, 'Extra Attack', 'Attack twice when you Attack.'),
            _fg(5, 'Stunning Strike',
                ...
                traits: [ref('trait', 'Stunning Strike')]),
            _fg(6, 'Empowered Strikes', 'Your Unarmed Strikes count as magical and you can make their damage Force.',
                traits: [ref('trait', 'Empowered Strikes')]),
            _fg(7, 'Evasion',
                ...
                traits: [ref('trait', 'Evasion')]),
            _fg(9, 'Acrobatic Movement', 'You can move along vertical surfaces and across liquids without falling while you move at least 10 feet.',
                traits: [ref('trait', 'Acrobatic Movement')]),
            _fg(10, 'Heightened Focus',
                'Your Flurry of Blows, Patient Defense, and Step of the Wind gain enhanced benefits.',
                traits: [ref('trait', 'Heightened Focus')]),
            _fg(15, 'Perfect Focus',
                'When you roll Initiative and don\'t use Uncanny Metabolism, regain Focus Points until you have 4 if you have 3 or fewer.',
                traits: [ref('trait', 'Perfect Focus')]),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'weapon_mastery_filter': 'proficient_any',
          'armor_training_refs': [
            lookup('armor-category', 'Light'),
            lookup('armor-category', 'Medium'),
            lookup('armor-category', 'Heavy'),
          ...
          'features': [
            _fg(1, 'Lay On Hands',
                ...
                bonusActions: [ref('creature-action', 'Lay on Hands')],
                traits: [ref('trait', 'Lay on Hands (Pool)')]),
            _fg(1, 'Spellcasting',
                'Half-caster on the Paladin list; Charisma is your spellcasting ability; your Holy Symbol is your spellcasting focus.',
                traits: [ref('trait', 'Spellcasting Focus')]),
            _fg(1, 'Weapon Mastery', 'Use the mastery property of two kinds of weapons; swap on a Long Rest.',
                traits: [ref('trait', 'Weapon Mastery')]),
            _f(2, 'Fighting Style', 'Gain a Fighting Style feat.'),
            _fg(2, 'Paladin\'s Smite',
                ...
                traits: [ref('trait', 'Paladin\'s Smite')]),
            _f(3, 'Paladin Subclass', 'Choose a subclass (Oath of Devotion in this SRD).'),
            _fg(3, 'Channel Divinity',
                'You gain Divine Sense as a base option, plus subclass options. Use Channel Divinity twice per Short Rest.',
                actions: [
                  ref('creature-action', 'Channel Divinity'),
                  ref('creature-action', 'Divine Sense'),
                ]),
            _f(4, 'Ability Score Improvement', ''),
            _f(5, 'Extra Attack', ''),
            _fg(5, 'Faithful Steed', 'You always have Find Steed prepared. You can also cast it once without expending a spell slot, regaining the ability on a Long Rest.',
                traits: [ref('trait', 'Faithful Steed')]),
            _fg(6, 'Aura of Protection',
                'You and friendly creatures within 10 feet of you gain a bonus to saving throws equal to your Charisma modifier (min +1).',
                traits: [ref('trait', 'Aura of Protection')]),
            _fg(9, 'Abjure Foes',
                ...
                actions: [ref('creature-action', 'Abjure Foes')]),
            _fg(10, 'Aura of Courage',
                'You and your allies have Immunity to the Frightened condition while in your Aura of Protection.',
                traits: [ref('trait', 'Aura of Courage')]),
            _fg(11, 'Radiant Strikes', 'Once per turn, when you hit with a weapon, deal +1d8 Radiant damage.',
                traits: [ref('trait', 'Radiant Strikes')]),
        ...
        attributes: {
          ...
          'features': [
            _fg(1, 'Favored Enemy',
                ...
                bonusActions: [ref('creature-action', 'Hunter\'s Mark (Class)')],
                traits: [ref('trait', 'Favored Enemy')]),
            _fg(1, 'Spellcasting',
                'Half-caster on the Ranger list; Wisdom is your spellcasting ability; you use a Druidic Focus.',
                traits: [ref('trait', 'Spellcasting Focus')]),
            _fg(1, 'Weapon Mastery', 'Use the mastery property of two kinds of weapons.',
                traits: [ref('trait', 'Weapon Mastery')]),
            _fg(2, 'Deft Explorer',
                'Gain Expertise in one of your skill proficiencies; learn an extra language. More benefits at higher levels.',
                traits: [ref('trait', 'Deft Explorer')]),
            _f(2, 'Fighting Style', 'Gain a Fighting Style feat.'),
            _f(3, 'Ranger Subclass', 'Choose a subclass (Hunter in this SRD).'),
            _fg(3, 'Roving', '+5 ft. Speed; you have a Climb Speed and Swim Speed equal to your Speed.',
                traits: [ref('trait', 'Roving')]),
            _f(4, 'Ability Score Improvement', ''),
            _f(5, 'Extra Attack', ''),
            _fg(9, 'Expertise', 'Choose two skills you\'re proficient in for Expertise.',
                traits: [ref('trait', 'Expertise')]),
            _fg(10, 'Tireless',
      ...
      packEntity(
        ...
        attributes: {
          ...
          'weapon_proficiency_categories': [lookup('weapon-category', 'Simple')],
          'weapon_mastery_filter': 'proficient_finesse_or_light',
          'granted_tool_refs': [ref('tool', "Thieves' Tools")],
          'granted_languages': [lookup('language', 'Thieves\' Cant')],
          'armor_training_refs': [lookup('armor-category', 'Light')],
          'caster_kind': 'None',
          'complexity': 'Average',
          ...
          'features': [
            ...
            _fg(1, 'Sneak Attack',
                ...
                traits: [ref('trait', 'Sneak Attack (Rogue)')]),
            _f(1, 'Thieves\' Cant',
                'You know Thieves\' Cant and a signed version of it.'),
            _fg(1, 'Weapon Mastery', 'Use the mastery property of two kinds of weapons.',
                traits: [ref('trait', 'Weapon Mastery')]),
            _fg(2, 'Cunning Action',
                'Bonus Action: Dash, Disengage, or Hide.',
                traits: [ref('trait', 'Cunning Action (Rogue)')]),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'features': [
            _fg(1, 'Spellcasting', 'Sorcerer cantrips/spells. Charisma is your casting ability.',
                traits: [ref('trait', 'Spellcasting Focus')]),
            _fg(1, 'Innate Sorcery',
            ...
            _f(4, 'Ability Score Improvement', ''),
            _fg(5, 'Sorcerous Restoration', 'Once per Short Rest, recover Sorcery Points (≤ half your Sorcerer level, rounded down).',
                traits: [ref('trait', 'Spellcasting Focus')]),
      ...
      packEntity(
        ...
        attributes: {
          ...
          'starting_gold_dice': '4d4 × 10',
          'features': [
            _fg(1, 'Eldritch Invocations',
                'Choose two Eldritch Invocations. Add more at higher levels.',
                traits: [ref('trait', 'Eldritch Invocations')]),
            _fg(1, 'Pact Magic',
                ...
                traits: [ref('trait', 'Pact Magic'), ref('trait', 'Spellcasting Focus')]),
            _fg(2, 'Magical Cunning',
                'On a Short Rest, regain expended pact slots equal to half your max (rounded up). Once per Long Rest.',
                traits: [ref('trait', 'Magical Cunning')]),
            _f(3, 'Warlock Subclass', 'Choose a subclass (Fiend Patron in this SRD).'),
            _fg(3, 'Pact Boon', 'Choose Pact of the Blade, Chain, or Tome.',
                traits: [ref('trait', 'Pact Boon')]),
            _f(4, 'Ability Score Improvement', ''),
        ...
        attributes: {
          ...
          'features': [
            ...
            _fg(1, 'Ritual Adept',
                ...
                traits: [ref('trait', 'Ritual Adept')]),
            _fg(1, 'Arcane Recovery',
