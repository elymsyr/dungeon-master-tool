...
List<Map<String, dynamic>> srdFeats() => [
      ...
      packEntity(
        ...
        attributes: {
          ...
          'repeatable': false,
          'ac_bonus': 1,
          'mechanical_notes': 'Only while wearing Light, Medium, or Heavy armor',
          'benefits':
      ...
      packEntity(
        ...
        attributes: {
          ...
          'asi_max_score': 30,
          'granted_senses': [
            {'sense_ref': lookup('sense', 'Truesight'), 'range_ft': 60},
          ],
          'benefits':
              'You gain the following benefits.\n\n'
                  '**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 30.\n\n'
      ...
      // ─── More Origin Feats ──────────────────────────────────────────────
      packEntity(slug: 'feat', name: 'Crafter', description: 'You gain proficiency with three Artisan\'s Tools and craft items more efficiently.', attributes: {'category_ref': lookup('feat-category', 'Origin'), 'repeatable': false, 'player_choices': [
        {
            'group_id': 'tools',
      ...
      packEntity(slug: 'feat', name: 'Lucky', description: 'You have a knack for being in the right place. You can spend Luck Points to alter d20 Tests.', attributes: {'category_ref': lookup('feat-category', 'Origin'), 'repeatable': false, 'resource_pool_grants': [
        {
          'pool_ref': lookup('resource-pool', 'pool:luck_points'),
          'recharge': 'long_rest',
          'count_formula': 'pb',
        },
      ], 'benefits': '**Luck Points.** You have a number of Luck Points equal to your Proficiency Bonus, and you regain all expended Luck Points when you finish a Long Rest.\n\n**Advantage.** You can spend a Luck Point when you make a d20 Test (attack roll, ability check, or saving throw); you have Advantage on the roll.\n\n**Disadvantage on Attacker.** When another creature rolls an attack roll against you, you can spend a Luck Point to give them Disadvantage.'}),
      packEntity(slug: 'feat', name: 'Musician', description: 'You can inspire allies with music, granting Bardic-like inspiration once per Long Rest.', attributes: {'category_ref': lookup('feat-category', 'Origin'), 'repeatable': false, 'player_choices': [
        {
      ...
      packEntity(slug: 'feat', name: 'Tavern Brawler', description: 'You learned to fight with whatever\'s at hand — chairs, mugs, fists.', attributes: {'category_ref': lookup('feat-category', 'Origin'), 'repeatable': false, 'asi_amount': 1, 'asi_max_score': 20, 'asi_ability_options': ['Strength', 'Constitution'], 'player_choices': [
        {
            'group_id': 'asi',
