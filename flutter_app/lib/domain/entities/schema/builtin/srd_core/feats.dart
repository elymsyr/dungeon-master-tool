...
List<Map<String, dynamic>> srdFeats() => [
        ...
        attributes: {
          ...
          'effects': [
            effect(
              ...
              value: 1,
              predicates: [
                predicate('equipped_armor_kind', {'value': 'not_none'}),
              ],
            ),
          ],
          'benefits':
      ...
      packEntity(
        ...
        attributes: {
          ...
          'asi_amount': 1,
          'asi_max_score': 30,
          // Shadowy Form — resistance to every damage type except Psychic +
          // Radiant while in Dim Light or Darkness. Resolver routes these
          // rows to `conditionalGrants` via the `has_state` predicate.
          'effects': [
            for (final dt in const [
              'Acid', 'Bludgeoning', 'Cold', 'Fire', 'Force', 'Lightning',
              'Necrotic', 'Piercing', 'Poison', 'Slashing', 'Thunder',
            ])
              {
                'kind': 'damage_resistance',
                'target_kind': 'damage-type',
                'target_ref': lookup('damage-type', dt),
                'predicates': [
                  {
                    'kind': 'has_state',
                    'args': {'ref': 'state:in_dim_or_darkness'},
                  },
                ],
              },
          ],
      ...
      packEntity(
        ...
        attributes: {
          ...
          'asi_max_score': 30,
          'effects': [
            effect('truesight_grant',
                targetKind: 'sense',
                targetRef: lookup('sense', 'Truesight')),
          ],
          'benefits':
              'You gain the following benefits.\n\n'
                  '**Ability Score Increase.** Increase one ability score of your choice by 1, to a maximum of 30.\n\n'
      ...
      packEntity(slug: 'feat', name: 'Lucky', description: 'You have a knack for being in the right place. You can spend Luck Points to alter d20 Tests.', attributes: {'category_ref': lookup('feat-category', 'Origin'), 'repeatable': false, 'effects': [
        {
      ...
      packEntity(slug: 'feat', name: 'Tough', description: 'Your HP maximum increases.', attributes: {'category_ref': lookup('feat-category', 'Origin'), 'repeatable': false, 'effects': [effect('hp_bonus_per_level', value: 2)], 'benefits': 'Your Hit Point maximum increases by an amount equal to twice your character level when you choose this feat. Whenever you gain a level thereafter, your HP maximum increases by an additional 2.'}),
      ...
      packEntity(slug: 'feat', name: 'Moderately Armored', description: 'You gain Medium Armor and Shield training.', attributes: {'category_ref': lookup('feat-category', 'General'), 'prereq_min_character_level': 4, 'prerequisite': 'Level 4+; proficiency with Light Armor', 'repeatable': false, 'asi_amount': 1, 'asi_max_score': 20, 'asi_ability_options': ['Strength', 'Dexterity'], 'effects': [effect('proficiency_grant', targetKind: 'armor_category', targetRef: lookup('armor-category', 'Medium')), effect('proficiency_grant', targetKind: 'armor_category', targetRef: lookup('armor-category', 'Shield'))], 'benefits': '**Ability Score Increase.** Increase your Strength or Dexterity score by 1, to a maximum of 20.\n\n**Armor Training.** You gain training with Medium Armor and Shields.'}),
      ...
      packEntity(slug: 'feat', name: 'Blind Fighting', description: 'You can fight without sight.', attributes: {'category_ref': lookup('feat-category', 'Fighting Style'), 'repeatable': false, 'effects': [
        {
          'kind': 'blindsight_grant',
          'target_kind': 'sense',
          'target_ref': lookup('sense', 'Blindsight'),
          'payload': {'range_ft': 10},
        },
