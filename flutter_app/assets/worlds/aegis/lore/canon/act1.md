...
> **Durum: çalışma taslağı.** README §0 kanon hiyerarşisine bağlıdır; 08 §2 akışını
> ve 07'nin ilkelerini (sahne akışını değil) uygular. Buradaki her madde ya bir
> kaynağa dayanır ya §8'de açık karar olarak durur. **Detay burada yazılmaz** —
> gerektiğinde arşivden çekilir.
...
**Mekanik yük (KARAR): 5e standart paketi + evrene özel feature + evrene özel eşya.**
Yani her background: 2 skill · tool/dil · **bu dünyaya ait bir feature** ·
**başlangıç envanterinde bu dünyaya ait bir eşya.** Eşya dekorasyon değil, kapı:
arşivcinin çantasındaki 2-3 arşiv kitabı bir "belgesel kapı" (07) taşıyıcısıdır,
lonca ajanının mührü kimlik açar, kaptanın seyir defteri rota bilgisi verir.
Eşyalar `item` kategorisine yazılır ve background kartından ref'lenir.

| Background | Artı (mekanik + kapı) | Eksi (kurgusal bedel) |
|---|---|---|
| **Arşivci** | Yazılı kayıt okuma/tasnif; Occulus dışı arşivlere giriş | Kayıt tutan kurum onu da kaydetmiştir; nerede olduğu bilinir |
| **Lonca Üyesi** | Lonca ağı: barınma, kredi, isim sorma hakkı | Loncanın işi öne geçer; çağrıldığında gitmemek statü kaybı |
| **Mertebeli Lonca Çocuğu** | Kapılar isimle açılır, para sorun değil | Yüzü tanınır; ailenin düşmanları da tanır. Kimliği saklamak zor |
| **Sihir Loncası Öğrencisi** | Formel büyü eğitimi; loncanın kütüphanesi | Öğrenci = denetim altında. İzinsiz kullanım kayda geçer |
| **Lonca Ajanı** | Söylenti toplama, sahte kimlik, gizli kanal | İki efendi. Loncanın çıkarı gruptan önce gelir; bir gün seçmesi gerekir |
| **Rıhtım İşçisi** | Liman/kargo/gemi bilgisi, kaçak yollar, işçi ağı | Kayıtsız iş kayıtsız insan yapar; resmi hiçbir kapıda ağırlığı yok |
| **Gemi Kaptanı** | Gemi kullanma, mürettebat, deniz rotaları | Gemi bir yükümlülüktür: borç, mürettebat, liman kaydı |
| **Paladin Askeri** | Silah eğitimi, düzenin lojistiği, kışla dili | Üniforma tanınır; halk kurumdan çekinir, kurum ondan itaat bekler |
| **Paladin Rütbelisi** | Emir verebilme, sorgusuz geçiş, düzen içi bilgi | Rütbe rapor demek. Sessiz kalmak da bir suç sayılır |
...
**Ad kuralı (KARAR):** köyde **halk dilinde/Türkçe** adlar, kurumlarda Latin
(Adlandırma Doktrini). Gümüşsu'nun adı Türkçe kaldığı gibi (README §3.1 M0.4),
insanları da öyle. Tam M5 dağarcığı yazılmadı; aşağıdaki yedi ad bu kuralın ilk
örneği ve dağarcık büyürken onlara uyulur.
...
**Üçlü: Toygar · Selvi · Demir.** **Sivil yolcular** — paladin değiller (KARAR).
**Gizli Liman'dan gelmişler** (KARAR) — yani kayıtsız girmişler. Kimse onları
aramıyor, kimse kaybolduklarını fark etmedi;
kayıtsız insanların kaybolması kayda geçmez. Şatoya bağ **kurulmuyor** — Paladin
Şatosu Act 1'de kendi kapısından girilecek bir yer, buranın uzantısı değil.

Gizli Liman seçimi zinciri kendiliğinden kuruyor: resmi limandan geçselerdi kayıt
olurdu. **Kayıt olmaması bir kaza değil, bir tercih** — birisi bu üç kişinin
görünmesini istememiş. Karaca'nın yolu bilmesi de aynı sebeple doğal: o da oradan
mal taşıyor.

Ensedeki cerrahi iğne 07'nin belkemiği — **korunur**: hastalık doğa değil, birinin
eseri. *Salgın araştırılmaz, suç araştırılır.* İğne oyuncular bakmazsa da orada
durur; ölümden sonra da bulunur. Sivil oldukları için iğne daha da kötü bir soru
sorar: **neden bu üç kişi?**

---

## 4. Hastalık — DM bilgisi

- **~1 ay** yavaş belirti: yorgunluk, iştahsızlık, damar renginin koyulaşması.
- Sonra **ani patlama.** Belirtiler saatler içinde biçim değiştirir — sabah öksüren
  biri akşam konuşamaz hale gelir. Bu değişkenlik hastalığın imzasıdır; iki hasta
  hiç aynı seyri izlemez.
- Son evre: bilinç gider, **beden güçlenir.** Blight insanı emir bekleyen bir ete
  çevirir (02 §2) — burası o dönüşümün ilk görüldüğü yer.
- Üçlü **şu an son evrenin eşiğinde.** Oyuncular bunu bilmiyor; kimse bilmiyor.

Oyuncuya ilk oturumda verilmez, gösterilir.
...
- **Ensedeki iğne** — kimse yorumlayamaz. Bu, üç kapının (07: bedensel · belgesel ·
  kültürel) hepsine giden ortak nesne.
...
| **Konsey aracısı** — açıkça orada | Limanın konseye yararlı kalması | Hangi konsey koltuklarının pay aldığı | "İyi yazı"nın nasıl alındığı |
...
Üçlünün izi burada bitmiyor, **burada başlıyor**: kaydın silinmesi bir tercihti
(§3) ve silmeyi birisi ödedi. Sicim'in defteri o soruyu somutlaştırır —
*kim ödedi.* Cevap limanda değil; Lonca ve Şehir hattında.
...
**Kapatılanlar (2026-09-08):** üçlü sivil · **Gizli Liman**'dan geldiler ·
Gümüşsu'nun 7 adı + halk dili/Latin ayrımı · background = 5e paketi + evrene özel
feature + evrene özel eşya · background eksisi kurgusal · liman iki kapılı
(kefil/iş/yük → yazı/para) · konsey limanı biliyor, tehdit işlemez.

**Açık:**

1. **Evrene özel 9 eşyanın kendisi** — her biri hangi kapıyı taşıyor, mekanik mi
   kurgusal mı. Background'lar yazılırken çıkacak.
2. **M5 kişi adı dağarcığının kalanı** — lonca / paladin / ork ad kalıpları. Act 1'in
   sonraki lokasyonları yazılmadan gerekmiyor.
3. **"İyi yazı" tam olarak nedir** — hangi konsey/lonca makamı verir, karşılığında ne
   ister. Lonca hattı yazılırken çıkacak.
4. **"İyi para"nın rakamı ve kazanma yolları** — limanda yapılabilecek 2-3 iş.
