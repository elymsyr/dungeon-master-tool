...
- [[LAN-Sync-Flow]] — aynı ağdaki iki cihaz arasında manuel, buluta uğramayan eşleme. **Kalkıyor** (`online-again` Faz 6); yerine tam online dönüyor — bulut şeması 094 ile kuruldu ([[migrations-cloud-mirror]]), istemcinin giden yolu Faz 4a'da bağlandı ([[cloud_push_service]]: Drift **v13** + watermark taraması), geri okuma Faz 5.
