...
- [[map_editor]] — stdlib-only browser editor for a bundled world's map pins; edits the `map_data` block in `world-blueprint.json` that [[bundled_worlds_installer]] seeds into the world.
