...
## Coverage in code
Hand-authored built-in pack [[srd_core_pack]] (`lib/domain/entities/schema/builtin/srd_core/`): 71 classes, 55 subclasses, 8 species (+35 subspecies), 29 backgrounds, 236 feats, 364 spells, ~325 monsters, magic items + gear. Wire format + ref placeholders via [[srd_helpers]]; card mechanics as named grant-block fields (see [[Grant-Resolution]]).
