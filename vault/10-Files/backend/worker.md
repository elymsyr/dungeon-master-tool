...
- Calls into `jwt.ts` (`verifyJwt`), `rate_limit.ts` (`checkRateLimit`), `rls.ts` (`checkAssetAccess`, `checkTransientAccess`, `checkPubUploadAllowed`, `popTransientEvictQueue`).
